...
const LecturerDashboardPage = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5041/api/Getters/GetUserDetails", {
    ...
    axios
      .get("http://localhost:5041/api/Reports/GetLatestReport", {
        withCredentials: true,
      })
      .then((response) => {
        if (Array.isArray(response.data)) {
          setreports(response.data);
          toast.success("Latest reports fetched successfully");
        } else {
          setreports([response.data]);
        }
      })
  ...
  const getStatusStyle = (status) => {
    const s = status;
    if (s === "Pending") return { color: " #684e09",
      backgroundColor: " #ebca8e",fontWeight: "bold" };
    if (s === "Reviewed" || s === "reviewed")
      return { color: "#238070",backgroundColor:" #b7e7db", fontWeight: "bold" };
          ...
          <div className="lecture-dashboard-main-body">
            <div className="lecture-dashboard-vertical-items">
              <div className="lecture-dashboard-item">
                <div className="lecture-dashboard-vertical-info">
                  <FontAwesomeIcon
                    icon={faFolder}
                    className="lecture-dashboard-vertical-items-icons"
                  />
                  <h4>
                    Total Reports
                    <br />
              ...
              <div className="lecture-dashboard-item">
                <div className="lecture-dashboard-vertical-info">
                  <FontAwesomeIcon
                    icon={faThumbsUp}
                    className="lecture-dashboard-vertical-items-icons2"
                  />
                  <h4>
                    Reviewed
                    <br />
              ...
              <div className="lecture-dashboard-item">
                <div className="lecture-dashboard-vertical-info">
                  <FontAwesomeIcon
                    icon={faClock}
                    className="lecture-dashboard-vertical-items-icons3"
                  />
                  <h4>
                    Pending Review
                    <br />
              ...
              <div className="lecture-dashboard-item">
                <div className="lecture-dashboard-vertical-info">
                  <FontAwesomeIcon
                    icon={faClipboard}
                    className="lecture-dashboard-vertical-items-icons4"
                  />
                  <h4>
                    Drafts
                    <br />
            ...
            <div className="lecture-dashboard-report-main-section">
              <div className="lecture-dashboard-report-section">
                ...
                <div className="lecture-dashboard-report-section-headings">
